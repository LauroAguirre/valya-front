...
export const mockProperties: Property[] = [
  {
    ...
    announcements: [
      { id: "a1", portal: "ZAP Imoveis", url: "https://zap.com.br", status: "ativo", publishedAt: "2026-02-01" },
      { id: "a2", portal: "Viva Real", url: "https://vivareal.com.br", status: "ativo", publishedAt: "2026-02-01" },
    ],
    adLinks: [
      { id: "ad1", platform: "facebook", campaignName: "Jardins Premium - Fev 2026", url: "https://facebook.com/ads/123" },
      { id: "ad2", platform: "instagram", campaignName: "Jardins Reels", url: "https://instagram.com/ads/456" },
    ],
    createdAt: "2026-01-15",
  },
  {
    ...
    images: [
      ...
      { id: "img5", url: "/placeholder.svg", description: "Piscina e area de lazer" },
    ],
    announcements: [
      { id: "a3", portal: "ZAP Imoveis", url: "https://zap.com.br", status: "ativo", publishedAt: "2026-01-20" },
    ],
    adLinks: [],
  ...
  },
  {
    ...
    announcements: [],
    adLinks: [
      { id: "ad3", platform: "tiktok", campaignName: "Leblon Luxo", url: "https://tiktok.com/ads/789" },
    ],
  ...
  },
  {
    ...
    images: [],
    announcements: [
      { id: "a4", portal: "OLX", url: "https://olx.com.br", status: "ativo", publishedAt: "2026-02-10" },
    ],
    adLinks: [],
  ...
  },
  {
    ...
    images: [
      ...
      { id: "img8", url: "/placeholder.svg", description: "Vista do condominio" },
    ],
    announcements: [],
    adLinks: [],
  ...
  },
  {
    ...
    isMultiUnit: true,
    units: [
      { id: "u1", name: "Unid 101", bedrooms: 2, parkingSpaces: 1, privateArea: 55, parkingArea: 12, totalArea: 67, downPayment: 48000, annualBonus: 12000, installmentValue: 1800, status: "disponivel" },
      { id: "u2", name: "Unid 102", bedrooms: 2, parkingSpaces: 1, privateArea: 55, parkingArea: 12, totalArea: 67, downPayment: 48000, annualBonus: 12000, installmentValue: 1800, status: "reservado" },
      { id: "u3", name: "Unid 201", bedrooms: 3, parkingSpaces: 2, privateArea: 72, parkingArea: 24, totalArea: 96, downPayment: 62000, annualBonus: 15000, installmentValue: 2400, status: "disponivel" },
    ...
    status: "ativo",
    images: [
      { id: "img9", url: "/placeholder.svg", description: "Fachada do empreendimento" },
    ],
    announcements: [
      { id: "a5", portal: "ZAP Imoveis", url: "https://zap.com.br", status: "ativo", publishedAt: "2026-02-15" },
    ],
    adLinks: [
      { id: "ad4", platform: "facebook", campaignName: "Flores do Campo - Lancamento", url: "https://facebook.com/ads/abc" },
      { id: "ad5", platform: "instagram", campaignName: "Flores do Campo Reels", url: "https://instagram.com/ads/def" },
    ],
    createdAt: "2026-02-10",
  },
]
...
export const mockClients: Client[] = [
  {
    ...
    payments: [
      { id: "pay1", date: "2026-02-01", amount: 197, status: "pago", method: "Cartao" },
      { id: "pay2", date: "2026-01-01", amount: 197, status: "pago", method: "Cartao" },
      { id: "pay3", date: "2025-12-01", amount: 197, status: "pago", method: "Cartao" },
    ],
  },
  {
    id: "cl2",
  ...
  },
  {
    ...
    payments: [
      { id: "pay4", date: "2026-01-01", amount: 397, status: "falhou", method: "Cartao" },
      { id: "pay5", date: "2025-12-01", amount: 397, status: "pago", method: "Cartao" },
    ],
  },
  {
    id: "cl4",
    ...
    payments: [
      { id: "pay6", date: "2026-02-01", amount: 197, status: "pago", method: "Boleto" },
      { id: "pay7", date: "2026-01-01", amount: 197, status: "pago", method: "Boleto" },
    ],
  },
  {
    id: "cl5",
    ...
    payments: [
      { id: "pay8", date: "2026-02-01", amount: 97, status: "pago", method: "PIX" },
    ],
  },
]
