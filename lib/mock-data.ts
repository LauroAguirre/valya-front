...
export const mockProperties: Property[] = [
  ...
  },
  {
    ...
    type: "cobertura",
    description:
      "Cobertura duplex com vista para o mar. 3 suites, terraço panoramico, jacuzzi. A 2 quadras da praia.",
  ...
  },
  {
    ...
    isMultiUnit: true,
    units: [
      { id: "u1", name: "Unid 101 - 2 dorms", area: 55, bedrooms: 2, salePrice: 480000, status: "disponivel" },
      { id: "u2", name: "Unid 102 - 2 dorms", area: 55, bedrooms: 2, salePrice: 480000, status: "reservado" },
      { id: "u3", name: "Unid 201 - 3 dorms", area: 72, bedrooms: 3, salePrice: 620000, status: "disponivel" },
      { id: "u4", name: "Unid 202 - 3 dorms", area: 72, bedrooms: 3, salePrice: 620000, status: "vendido" },
      { id: "u5", name: "Unid 301 - 2 dorms", area: 55, bedrooms: 2, salePrice: 495000, status: "disponivel" },
    ],
    status: "ativo",
    images: [
...
export const mockKanbanColumns: KanbanColumn[] = [
  {
    ...
    title: "Qualificacao",
    color: "bg-chart-3",
    cards: mockLeads.filter((l) => l.status === "novo" || l.status === "qualificado"),
  },
  {
    id: "cadencia",
    title: "Cadencia",
    color: "bg-chart-2",
    cards: mockLeads.filter((l) => l.status === "em_cadencia"),
  },
  {
    id: "visita",
    title: "Visita",
...
export const clientKpis: KpiData[] = [
  { label: "Leads Ativos", value: 24, change: 12, changeLabel: "vs mes anterior" },
  { label: "Em Cadencia", value: 8, change: -3, changeLabel: "vs mes anterior" },
  { label: "Taxa de Conversao", value: "18%", change: 5, changeLabel: "vs mes anterior" },
  { label: "Imoveis Cadastrados", value: 7, change: 2, changeLabel: "novos este mes" },
]
